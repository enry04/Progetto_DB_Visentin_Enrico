...
<body>
    <main class="container">
        <header class="site-header">
            ...
            <p><a class="btn" href="dashboard.php">Vedi statistiche</a></p>
        </header>
        ...
        <section class="grid">
            <article class="card">
                ...
                <form method="post">
                    ...
                    <div class="field"><label>Codice partita<input type="text" name="codicePartita" required></label>
                    </div>
                    <div class="field"><label>Codice arbitro<input type="text" name="codiceArbitro" required></label>
                    </div>
                    <div class="field"><label>1° guardalinee<input type="text" name="codicePrimoGuardalinee"
                                required></label></div>
                    <div class="field"><label>2° guardalinee<input type="text" name="codiceSecondoGuardalinee"
                                required></label></div>
                    <div class="field"><label>Quarto uomo<input type="text" name="codiceQuartoUomo" required></label>
                    </div>
            ...
            <article class="card">
                ...
                <form method="post">
                    ...
                    <div class="field"><label>Numero tesseramento giocatore<input type="text"
            ...
            <article class="card">
                ...
                <form method="post">
                    ...
                    <div class="field"><label>Codice partita<input type="text" name="codiceGaraSpettatori"
                                required></label></div>
                    <div class="field"><label>Numero spettatori<input type="number" name="numeroSpettatori" min="0"
                                required></label></div>
            ...
            <article class="card wide">
                ...
                <form method="post">
                    ...
                    <div class="field"><label>Codice partita<input type="text" name="codiceGaraRisultato"
                                required></label></div>
                    <div class="field"><label>Stato partita<input type="text" name="statoPartita" required
                                placeholder="es. conclusa"></label></div>
                    <div class="field"><label>Risultato<input type="text" name="risultatoPartita" required
                                placeholder="es. 2-1"></label></div>
